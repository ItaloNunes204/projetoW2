...
public class cadastroDeAluno {
    ...
    public void cadastroDeAluno(aluno a){
     try {
            String SQL="INSERT INTO italo_pereira.aluno (nome,sobrenome,senha,email,CPF)VALUES(?,?,?,?,?)";
        ...
        try {
            String SQL="SELECT nome,sobrenome,senha,email,cpf FROM italo_pereira.aluno";
